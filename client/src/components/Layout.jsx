...
import { 
  ...
  Phone, TrendingUp, Settings, LogOut, Menu, X
} from 'lucide-react'
...
const Layout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { path: '/oportunidades', icon: Briefcase, label: 'Oportunidades' },
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      `}>
        ...
        <div className="p-4 border-t border-gray-700 bg-gray-800">
          ...
          >
            <LogOut size={20} />
            {sidebarOpen && <span className="ml-3 truncate">Cerrar Sesion</span>}
          </button>
        </div>
      </div>
